...
import { ExternalLink, User, UserPlus, Menu, ChevronDown, LogOut, Settings, Search, X } from 'lucide-react'
      ...
      <nav className="shadow-lg px-6 py-4 md:px-8 bg-white border-b border-gray-100">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="md:hidden text-gray-700 hover:text-green-600 transition-colors p-2 rounded-lg hover:bg-gray-100"
          >
            {isMobileMenuOpen ? (
              <X className="w-7 h-7" />
            ) : (
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold" style={{ color: '#0F5D8C' }}>Menu</h2>
                <button
              ...
              {user ? (
                <>
                  ...
                  <div className="mb-6 p-4 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center">
                        <span className="text-green-800 font-medium text-lg">{getInitials(user.name)}</span>
                      </div>
                      <div>
                  ...
                  {user.role === 'admin' ? (
                    <Button 
                      ...
                      className="w-full bg-[#79B749] hover:bg-green-600 text-white mb-6"
                    >
                    ...
                    <Button 
                      onClick={() => {
                        router.push('/candidat/candidature-spontanee')
                        closeMobileMenu()
                      }}
                      className="w-full bg-[#79B749] hover:bg-green-600 text-white mb-6"
                    >
                  ...
                  <nav className="space-y-1">
                    {user.role === 'admin' ? (
                      ...
                      <>
                        ...
                        <Link
                          href="/candidat/candidature-spontanee"
                          onClick={closeMobileMenu}
                          className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                        ...
                        <Link
                          href="/candidat/mes-candidatures"
                          onClick={closeMobileMenu}
                          className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                ...
                <Link href="/signin" onClick={closeMobileMenu}>
                  <Button className="w-full bg-[#79B749] hover:bg-green-600 text-white flex items-center gap-2 rounded-full px-6 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    <User className="w-4 h-4" />
                    Se connecter
                  </Button>
                </Link>
                <Link href="/signup" onClick={closeMobileMenu}>
                  <Button variant="outline" className="w-full border-[#79B749] text-[#79B749] hover:bg-[#79B749] hover:text-white flex items-center gap-2 rounded-full px-6 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 border bg-white">
                    <UserPlus className="w-4 h-4" />
                    S&apos;inscrire
                  </Button>
                </Link>
                    {/* <Link href="/signin" onClick={closeMobileMenu}>
                      <Button className="w-full bg-[#79B749] hover:bg-green-600 text-white">
                        <User className="w-4 h-4 mr-2" />
                        Se connecter
                      </Button>
                    </Link>
                    <Link href="/signup" onClick={closeMobileMenu}>
                      <Button variant="outline" className="w-full border-[#79B749] text-[#79B749] hover:bg-[#79B749] hover:text-white">
